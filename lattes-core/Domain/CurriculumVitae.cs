...
public class CurriculumVitae
{
	...
	public CurriculumVitae(CurriculumVitaeDTO? cv)
	{
		...
		{
			Institution = cv.DADOSGERAIS.FORMACAOACADEMICATITULACAO.GRADUACAO[0].NOMEINSTITUICAO,
			Course = cv.DADOSGERAIS.FORMACAOACADEMICATITULACAO.GRADUACAO[0].NOMECURSO,
			ThesisTitle = cv.DADOSGERAIS.FORMACAOACADEMICATITULACAO.GRADUACAO[0].TITULODOTRABALHODECONCLUSAODECURSO,
		};
		
		Masters = new Masters
		{
			Institution = cv.DADOSGERAIS.FORMACAOACADEMICATITULACAO.MESTRADO[0].NOMEINSTITUICAO,
			Course = cv.DADOSGERAIS.FORMACAOACADEMICATITULACAO.MESTRADO[0].NOMECURSO,
			ThesisTitle = cv.DADOSGERAIS.FORMACAOACADEMICATITULACAO.MESTRADO[0].TITULODADISSERTACAOTESE,
		...
		{
			Institution = cv.DADOSGERAIS.FORMACAOACADEMICATITULACAO.DOUTORADO[0].NOMEINSTITUICAO,
			Course = cv.DADOSGERAIS.FORMACAOACADEMICATITULACAO.DOUTORADO[0].NOMECURSO,
			ThesisTitle = cv.DADOSGERAIS.FORMACAOACADEMICATITULACAO.DOUTORADO[0].TITULODADISSERTACAOTESE,
